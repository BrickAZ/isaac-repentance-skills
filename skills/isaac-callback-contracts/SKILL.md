...
For a declared required or optional REPENTOGON surface, use
`isaac-repentogon-callbacks` for changed vanilla arguments, return chains,
priority, inventory/loot events and unload timing. Its matching-build dispatcher
contract takes precedence over generic vanilla callback advice here. Keep this
skill for registration ownership and filters; compat supplies the version gate.
